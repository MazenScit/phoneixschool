         ...
         backgroundColor: globalcolor,
          ...
          ElevatedButton(
            style: ButtonStyle(
             ...
             child: Text("بدء التحميل",style: TextStyle(fontSize: 9,color: globalcolor),),
          ):Center(child: Text((myreceived / mytotal * 100).toStringAsFixed(0) + "%",style: TextStyle(color: Colors.white),))
          :ElevatedButton(
            style: ButtonStyle(
